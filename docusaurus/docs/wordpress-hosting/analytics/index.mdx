...
You can use the default analytics view provided by WordPress Hosting, or connect your own Google Analytics 4 (GA4) property for site-specific data. The dashboard shows metrics like active users, page views, session duration, and where your traffic is coming from.
...
- **[Add your own Google Analytics account](add-your-own-analytics-account.md)**: Connect your GA4 property and add a custom Measurement ID
- **[Toggle the default Google Analytics tracking on/off](../advanced-tools/toggle-the-default-google-analytics-tracking-onoff.md)**: Enable or disable default tracking without removing your connection
...
When you first set up your site, WordPress Hosting can collect analytics data using a shared Google Analytics ID. This provides basic metrics, but the ID is shared across multiple sites.

### Custom Google Analytics View
Connecting your own Google Analytics account gives you data specific to your site. You can:
...
2. **Connect Your Own Account**: Connect your own Google Analytics account:
   * Go to **Business App > Administration > Connections** to connect Google Analytics
   * Or add your GA4 Measurement ID (`G-XXXXXXXXXX`) in **WordPress Dashboard > Settings > General > Custom Google Analytics Tracking ID**
...
Connecting your own Google Analytics account gives you site-specific data because:
...
If you're still not seeing data, verify your connection in **Business App > Administration > Connections** and ensure your GA4 Measurement ID is correctly entered in **Settings > General**.
...
While plugins are available, they often fail to track data properly in the WordPress Hosting environment. Use the built-in tracking field in **Settings > General** or manually add the script in Divi Theme Options.
...
<details>
<summary>How do I disable the default Google Analytics tracking for GDPR compliance?</summary>
...
For more detailed information, see [Toggle the Default Google Analytics Tracking On/Off](../advanced-tools/toggle-the-default-google-analytics-tracking-onoff.md) in Advanced Tools.
