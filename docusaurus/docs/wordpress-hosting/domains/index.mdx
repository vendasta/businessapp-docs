...
- **[Connect a Custom Domain](connect-a-custom-domain.md)**: Step-by-step guide to connecting your custom domain using DNS records
- **[Set up your domain](set-up-your-domain.md)**: Configure A and CNAME records for your domain
...
- **[Point your GoDaddy domain from your old host to WordPress Hosting](point-your-godaddy-domain-from-your-old-host-to-wordpress-hosting.md)**: GoDaddy-specific instructions for transferring domains
...
The process is the same, but you can find GoDaddy-specific instructions in [Point a new Domain to WordPress Hosting](point-a-new-domain-to-wordpress-hosting.md) or [Point your GoDaddy domain from your old host to WordPress Hosting](point-your-godaddy-domain-from-your-old-host-to-wordpress-hosting.md).
