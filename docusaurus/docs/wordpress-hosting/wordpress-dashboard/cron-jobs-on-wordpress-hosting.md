...
description: "Learn about WordPress Hosting Pro's automated scheduled tasks system that handles posts, backups, and emails automatically."
---
...
For other WordPress Hosting Pro platform features and advanced tools, see [Advanced Tools](../../advanced-tools/index.mdx).
