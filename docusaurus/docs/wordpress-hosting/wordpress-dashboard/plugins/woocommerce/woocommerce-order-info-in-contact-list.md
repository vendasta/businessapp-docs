...
When a new customer makes an order on your WooCommerce-enabled WordPress Hosting **Standard or Pro** website, their information (name, email address, and phone number) is automatically synced to your Customer List in Business App. This allows you to contact them through email, phone, Customer Voice, or other ways to build and strengthen your customer relationships.
...
Learn more about managing contacts in Business App's [CRM Contacts](/business-app/crm/contacts) section.
