...
Divi is a popular WordPress theme and page builder plugin developed by Elegant Themes, offering a flexible and powerful design experience. Whether you're building websites from scratch or customizing existing ones, Divi makes it easy to create beautiful, responsive sites without the need for coding expertise. In this article, we will explain what Divi is, how it works on the WordPress Hosting platform, and whether you need both the Divi plugin and theme.
...
### How Does Divi Work on the WordPress Hosting Platform?
...
*   **Seamless Compatibility**: WordPress Hosting fully supports both the Divi theme and Divi Builder plugin, making it easy to design responsive, beautiful websites with minimal effort.
...
Divi is an excellent solution for building customizable, responsive WordPress websites, and it works seamlessly with the WordPress Hosting platform. WordPress Hosting offers a default Divi theme license with each new website you create, so you don't have to worry about purchasing Divi separately. However, for additional add-ons or premium features, you will need to acquire those licenses separately from Elegant Themes.

Whether you choose to use the Divi theme or the Divi Builder plugin depends on your preferences and needs. By combining Divi with WordPress on WordPress Hosting, you get a powerful and flexible solution for creating professional websites with ease.
