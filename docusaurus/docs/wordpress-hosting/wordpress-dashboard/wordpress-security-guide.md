...
1.  **Security Vulnerabilities** – XML-RPC has been historically targeted by **brute-force attacks** and **DDoS attacks**. Since it allows external services to communicate with your website, it opens a door that attackers could exploit to gain unauthorized access or flood your site with malicious traffic.
...
If you need XML-RPC for any of the reasons mentioned above, such as using mobile apps or integrating third-party tools, you can enable it. Some cases where you need XML-RPC include:
