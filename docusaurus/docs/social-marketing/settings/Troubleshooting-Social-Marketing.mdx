---
title: "How do I troubleshoot errors in Social AI?"
description: "Fix common Social AI posting and connection errors for Facebook, Instagram, LinkedIn, Google Business Profile, and X, including expired tokens."
...
kb_id: KB-00130
answer_snippet: "Most Social AI posting errors come from an expired or broken social account connection. To fix them, reconnect the account in Social AI settings and accept all requested permissions, then follow the platform-specific fixes for Facebook, Instagram, LinkedIn, Google Business Profile, or X."
...
# How do I troubleshoot errors in Social AI? {#troubleshooting-errors-in-social-ai}

Most Social AI posting errors come from an expired or broken social account connection. To fix them, reconnect the account in Social AI settings and accept all requested permissions, then follow the platform-specific fixes for Facebook, Instagram, LinkedIn, Google Business Profile, or X. This guide covers the most common error messages, what they mean, and how to fix them.
...
## How do I fix Facebook errors? {#facebook-troubleshooting}
...
## How do I fix Instagram errors? {#instagram-troubleshooting}
...
- **Fix it:**
  - Go to `IG App` > `Profile` > `Edit Profile` > `Page` and select the Facebook Page to connect
...
## How do I fix LinkedIn errors? {#linkedin-troubleshooting}
...
## How do I fix Google Business Profile errors? {#google-business-profile-troubleshooting}
...
- **Fix it:** Update your business category, or contact your provider to update it

---

## How do I fix X (Twitter) errors? {#x-twitter-troubleshooting}
...
## Why did my post fail to publish? {#general-posting-failures}
...
2. Remove the app from the platform (for example, `Facebook` > `Apps & Websites`)  
3. Clear your browser cache or use an incognito/private window  
4. Try using a different browser  

---

## How do I prevent connection errors? {#tips-to-prevent-future-issues}
...
<details>
<summary>Why does my LinkedIn connection keep expiring?</summary>

LinkedIn requires you to reconnect every 60 days. You see a yellow banner 10 days before the connection expires. Go to `Settings` > `Connect Accounts` and click **Reconnect** beside LinkedIn.

</details>

<details>
<summary>Why did my Facebook or Instagram connection expire?</summary>

The connection token has expired or broken. Meta may also flag a token after sudden account changes, such as a new admin or a password reset, an admin location mismatch, or high-frequency posting. Reconnect the account and accept all permissions, or verify your identity with Meta if prompted.

</details>

<details>
<summary>What happens to scheduled posts while a connection is expired?</summary>

Social AI saves failed scheduled posts to Drafts. Reconnect the account and reschedule the posts from Drafts. If the product is deactivated, posts can't be recovered.

</details>

<details>
<summary>Why can't I connect my Instagram account?</summary>

Social AI can only post to Instagram Business or Creator accounts that are linked to a Facebook Page. You also need Admin or Editor access to that Facebook Page.

</details>

<details>
<summary>What does the (#100) error mean?</summary>

A (#100) error means permissions weren't granted properly. Reconnect the Facebook account and accept all requested permissions.

</details>

<details>
<summary>How long does reconnecting take?</summary>

Reconnecting only takes a few seconds. Reconnect when you see an expiration banner to avoid failed posts.
