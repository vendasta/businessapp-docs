...
The YouTube integration in Social Marketing allows you to connect your YouTube channel and publish video content directly from within the platform. You can draft, schedule, or immediately post videos to YouTube without leaving Social Marketing.
...
No. It is only available to users with an active Social Marketing Pro subscription.
