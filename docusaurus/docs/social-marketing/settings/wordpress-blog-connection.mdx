...
- The Website URL and Access Token must match the connected account exactly for the connection to succeed.
![WordPress valid connection key](./img/wordpress/wordpress-valid-connection-key.png)
