---
title: "AI Settings in Social AI"
sidebar_label: AI settings
description: "Learn how to configure AI Settings in Social AI Pro to create better, brand-aligned social media content using Common Instructions and AI Knowledge."
sidebar_position: 3
tags: [social-ai, ai, content-creation, setup]
keywords: [AI social media, social ai, AI settings, content automation, AI brand alignment, social ai pro]
---

# AI Settings in Social AI

The **AI Settings** feature in **Social AI Pro** empowers users to create high-performing, brand-aligned social media content with greater ease and efficiency. By configuring AI instructions and knowledge settings, you help Social AI better understand your business and generate posts that are relevant, consistent, and on-brand.
...
Social AI shares its AI Knowledge base with other AI Assistants such as:

- **Web Chat AI Assistant**

If AI Knowledge is updated in Social AI:
...
Currently, knowledge added through Social AI **cannot be deleted directly** from within the platform.
...
The **AI Settings** in Social AI help you deliver smarter, more effective social media content through two main tools:
...
Currently, AI Settings (Common Instructions and Knowledge) apply globally to your Social AI instance to ensure a consistent brand voice across all channels.
...
You cannot delete knowledge directly inside Social AI at this time. You must go to **Business App > Administration > AI Settings > AI Knowledge Base** to manage and remove entries.
