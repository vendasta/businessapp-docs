...
sidebar_label: AI settings
description: "Learn how to configure AI Settings in Social Marketing Pro to create better, brand-aligned social media content using Common Instructions, Additional Instructions, and AI Knowledge."
sidebar_position: 3
tags: [social-marketing, ai, content-creation, setup]
keywords: [AI social media, social marketing AI, AI settings, content automation, AI brand alignment, social marketing pro]
---
...
This article will walk you through the key components of AI Settings:
...
The **Additional Instructions** field lets you provide specific guidance or preferences for **Write with AI** when composing individual posts in the Social Marketing individual product (Premium/PRO).

> **Note:** Instructions entered here apply only to **Write with AI**. They do not apply to Social Media Manager or Blogger. To set preferences for those tools, use **Customize Social and Blog Post Instructions** in the configuration.

### How to Add Additional Instructions

1. Navigate to **Settings > AI Settings > Additional Instructions**
2. Enter your instructions or preferences in the text field
3. Click **Save**

---

## 3. AI Knowledge in Social Marketing
...
The **AI Settings** in Social Marketing help you deliver smarter, more effective social media content through three main tools:

- **Common Instructions** for campaign-level guidance  
- **Additional Instructions** for Write with AI in the individual product  
...
<details>
<summary>Can I have different AI settings for different social accounts?</summary>

Currently, AI Settings (Common Instructions and Knowledge) apply globally to your Social Marketing instance to ensure a consistent brand voice across all channels.

</details>

<details>
<summary>How long does it take for AI to learn from my website?</summary>

The crawling process is usually fast (minutes), but it depends on the size of the site. Once you save the knowledge, the AI is immediately updated with the new information.

</details>

<details>
<summary>Can I delete AI knowledge I added by mistake?</summary>

You cannot delete knowledge directly inside Social Marketing at this time. You must go to **Business App > Administration > AI Settings > AI Knowledge Base** to manage and remove entries.
