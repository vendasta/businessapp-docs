---
title: Connecting and Managing Accounts in Social AI
sidebar_label: Account connections
description: Learn how to connect and manage social media accounts and WordPress blogs using Social AI.
sidebar_position: 2
brand: business-app
...
# Connecting and Managing Accounts in Social AI

Social AI empowers you to connect and manage multiple social media accounts and a WordPress blog from one centralized platform. Whether you're scheduling content, monitoring engagement, or sharing blog posts automatically, Social AI simplifies your social media presence.

---

## Supported Social Media Platforms

Social AI supports integration with a wide range of platforms:
...
1. **Access Settings**: Navigate to **Social AI > Settings > Connections**
...
4. **Grant Permissions**: Approve access for Social AI to manage content
...
- **Permission Control**: Manage what Social AI can access  
...
- **Post Management**: Manage content within Social AI  
...
While Social AI supports connecting multiple locations on most networks, the number of connections is limited by social networks.
...
It is recommended to have Social AI activated for each individual location, due to the unique content policies followed by the different social media platforms.
...
<details>
<summary>Do I need a personal LinkedIn account to post to a LinkedIn business page?</summary>

Yes. A LinkedIn business page can only be connected through a personal LinkedIn account that has access to it, so the personal account has to be connected as well.

Once both are connected you do not have to post to the personal profile. In the post composer, clear the personal profile from the list of destination channels and click `Save as default` so it stays deselected on future posts. You can still select it individually whenever you do want to post there.
...
**To distinguish between account types in Social AI:**
...
However, **you can remove a LinkedIn business page** from Social AI **without affecting the connected personal account**.
</details>

<details>
<summary>Can I connect multiple Google Business Profile pages or switch between them?</summary>

Due to limitations imposed by Google Business Profile, **only one GBP location can be connected at a time** in Social AI.
...
1. Go to **Settings > Connect Accounts** in Social AI.
...
Yes. In order to connect an Instagram account to Social AI, it **must be linked to a Facebook Page**. This can be done through:
...
while posting from Social AI, follow these steps:
...
7. Return to Social AI:
   - Disconnect the Instagram account.
   - Reconnect it.
8. Retry any previously failed posts.

  Social AI can only post through Business Instagram accounts.
</details>

<details>
<summary>Will changing the password on a social account affect its connection in Social AI?</summary>

Yes. Changing the password on any connected social media account (LinkedIn, Facebook, Instagram, GBP) will **invalidate the connection token**. You will need to **reconnect** the account in Social AI to restore functionality.
</details>
...
By connecting your social media accounts and WordPress blog to Social AI, you unlock powerful tools for automation, scheduling, analytics, and engagement—all from one platform. Whether you're managing multiple brands or just looking to amplify your blog reach, Social AI makes it simple and effective.