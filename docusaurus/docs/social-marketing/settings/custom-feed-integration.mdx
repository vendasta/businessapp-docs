...
tags: [social-marketing, integration, rss-feed]
keywords: [custom feed integration, RSS to social, automate social posts, social marketing feed, external content sync]
---
...
If the source feed goes down or changes its format, Social Marketing will stop pulling new content. You may need to update the feed URL in settings to restore functionality.
