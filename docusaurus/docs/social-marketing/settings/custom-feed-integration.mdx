...
sidebar_label: Custom feed
description: "Learn how to set up custom feed integration in Social AI"
tags: [social-ai, integration, rss-feed]
keywords: [custom feed integration, RSS to social, automate social posts, social ai feed, external content sync]
---

# Custom Feed Integration

Social AI's custom feed integration allows you to automatically pull content from external sources and share it on your social media platforms.

## Setting Up Custom Feed Integration

1. **Access Settings**: Go to **Social AI > Settings > Integrations**
...
<details>
<summary>What happens if the RSS feed stops working?</summary>

If the source feed goes down or changes its format, Social AI will stop pulling new content. You may need to update the feed URL in settings to restore functionality.
