...
sidebar_label: Add Facebook pages
...
5. Go back to Social AI in our platform and proceed to connect any account. This will automatically re-authenticate the App for all accounts managed by that profile and will also show you the new account you are trying to connect.

Please be aware that these steps will disconnect all Facebook accounts temporarily and all connections will be reinstated once one account is connected back to Social AI, as explained in step 5.