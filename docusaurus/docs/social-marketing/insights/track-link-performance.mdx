...
sidebar_label: Link performance
description: "Learn how to track the performance of shortened links in Social AI"
sidebar_position: 4
---

In Social AI, you can track how many clicks your shortened links get, broken down by platform.
...
To see link performance in Social AI, go to `Insights` → `Link Performance`.

![Link Performance dashboard](./img/link-performance-new.png)
...
Social AI Pro is required for this feature.