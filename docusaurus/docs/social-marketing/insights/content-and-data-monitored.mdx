...
*\*\*\* Due to Google Business Profile API restrictions, all previous posts will be shown, but only reach and engagement data from 530 days before the connection date will be reported within Social Marketing.*
