...
description: Learn about the insights and analytics available in Social AI to help you understand your social media performance.
sidebar_position: 1
---

The Insights tab in Social AI offers a detailed look at your content performance across social platforms. Divided into two main sections, **Link Performance** and **Post Performance**, this dashboard helps you understand the reach and effectiveness of your social strategy, prove ROI, and optimize future content.

## Why use Insights?

- Track post performance across all connected social platforms
- Measure link clicks and traffic from shortened URLs
- Identify top-performing content and engagement trends
- Prove ROI with data-backed reports
- Optimize posting times and content strategy

## What's included

- **[Content and Data Monitored](content-and-data-monitored.mdx)**: Understanding what data is tracked across platforms
...
2. Click `Post Performance` to see reach, engagement, and impressions for your posts.
3. Click `Link Performance` to track clicks on shortened URLs.
4. Identify your top-performing posts and content types.
5. Use the data to refine your posting schedule and content strategy.
...
### What's included:
- **Shortened Link Tracking**: Automatically tracks click-throughs on links created using Social AI's link shortener.
...
:::info
This feature is available with Social AI Pro.
:::

## Post Performance

The **Post Performance** section provides in-depth analytics on the social posts you've published through the Social AI platform—and in some cases, posts created outside the platform.
...
<details>
<summary>What social media platforms does Social AI monitor for post performance?</summary>

Social AI tracks post content, reach, engagement, and customer replies across:
- **Facebook**: Yes to all
...
- **LinkedIn**: Yes (no replies for posts made outside Social AI)
...
<details>
<summary>Can Social AI pull data from posts published outside the app?</summary>

<!-- SME review (2026-07-13): This LinkedIn claim, and the "Up to 1,000 previous posts" claim in the "How can I access historical data for LinkedIn and GBP?" FAQ below, conflict with the "Newly-connected accounts" table in content-and-data-monitored.mdx, which shows No for LinkedIn previous posts / reach & engagement / replies with no reconnect exception. Needs SME confirmation on which reflects current behavior. Tracked via GitHub issue follow-up comment. -->

Yes, in many cases. Social AI can import historical post data from the following platforms:
...
:::note
LinkedIn data limitations are imposed by LinkedIn's API.
:::
</details>
...
Yes. Visit `Social AI` → `Insights` → `Post Performance` to:
