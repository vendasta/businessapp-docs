...
description: "Learn how to create and use post templates in Social AI"
...
Social AI's post template feature allows you to create reusable templates for your social media posts, saving time and ensuring consistency across your content.
...
![Save post as template in Social AI](img/new-template.png)
