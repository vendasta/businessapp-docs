...
sidebar_label: Post render plugin
description: "Learn how to use the Social AI Post Render plugin to display social media posts from your business directly on your WordPress website"
sidebar_position: 6
---

## What is the Social AI Post Render Plugin?

The Social AI Post Render plugin allows you to display social media posts from your business directly on your WordPress website. With a simple shortcode, you can fetch and render posts, making it easy to keep your website updated with the latest social media content.

## How to use the Social AI Post Render Plugin
