...
- **Choose a Post** across any supported platform (e.g., Facebook, LinkedIn, Instagram, X (Twitter))
...
<details>
<summary>Are there any limitations for viewing comments on X (Twitter) posts?</summary>

New comments on X (Twitter) posts can take up to an hour to appear in your dashboard. X also only makes conversations from the past 7 days available, so comment threads on older posts may show incomplete results.
