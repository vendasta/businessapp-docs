...
tags: [social-marketing, reporting, calendar]
...
3. **Choose Post Types**: Select which types of posts to include (scheduled, drafts, or both)
   - Drafts in report view are sorted by their scheduled date.
...
- **Draft sorting in reports**: Drafts are ordered by scheduled date
...
Currently, reports are secured via a generated unique link. While not password-protected in the traditional sense, the link is difficult to guess and serves as the access key.
...
No, the report view is read-only. It is designed for reviewing scheduled content, not editing it. Any changes must be made within the Social Marketing account.

</details>

<details>
<summary>How are drafts sorted in a report?</summary>

Drafts in report view are sorted by scheduled date.
