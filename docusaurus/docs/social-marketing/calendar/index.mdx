...
Anyone with access to the Social Marketing product for that business location can view the calendar and its content. Any person can see the content within the report link, regardless of access to Social Marketing.
</details>
