...
sidebar_position: 1
description: See scheduled and draft posts, create new posts, and share calendar reports, all from one visual calendar view.
---

The `Calendar` tab in the Social AI product provides an easy, visual way to manage all your social content. From scheduling new posts to viewing drafts, it helps you stay organized and confident in your publishing strategy, all in one place.

![Calendar view](img/social-calendar.png)
...
![Create a calendar report link](img/social-calendar-report.png)
...
The calendar displays posts across all connected platforms in one view. You can filter by specific platforms in the `Posts` tab.
</details>

<details>
<summary>How do I edit a post I see on the calendar?</summary>

Click on the post within the calendar, then click edit, and it will open in the post composer for changes.
...
Yes. Click the post and choose the delete option from the post editor screen.
...
Anyone with access to the Social AI product for that business location can view the calendar and its content. Any person can see the content within the report link, regardless of access to Social AI.
</details>

<details>
<summary>What kind of reports can I generate?</summary>

You can create a **calendar report** summarizing upcoming and draft posts, which can be shared for stakeholder review.
</details>
