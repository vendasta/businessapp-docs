...
sidebar_position: 1
tags: [social-ai, composer, posting, facebook-stories, facebook-reels, youtube]
keywords: [social media posts, schedule posts, compose posts, facebook stories, facebook reels, youtube]
---

## What is Posts Overview?

The Social AI Composer helps you create, schedule, and manage social media content across multiple platforms in one place. Whether posting a single update or running a campaign, you can customize each post for every network.
...
- **[Long-Form Blog Content](create-and-publish-long-form-blog-content.mdx)**: Publish blog content through Social AI
...
5. **Add Media**
   ...
   - YouTube requires a video and a title (set in `Advanced Options`).
6. **Schedule or Publish**
   - Choose `Post Now`, `Schedule`, or `Save as Draft`.

![Social AI Composer](img/Social-marketing-composer.png)
...
* `Advanced Options` section lets you select `Post` or `Story` as the publish type.
* The preview updates based on your selection in real time.

![Social AI Composer Facebook Preview](img/Social-marketing-composer-Facebook-Preview.png)
...
![Social AI Composer Instagram and TikTok Preview](img/Social-marketing-composer-Instagram-and-TikTok-Preview.png)
...
:::
![Social AI Composer Google Business Profile Preview](img/Social-marketing-composer-Google-Business-Profile-Preview.png)

### YouTube

* YouTube is available in the Post Composer, Long Video, and Campaign workflows.
* **Required**: Video upload and Video Title (via `Advanced Options`).
* **Privacy Settings**: Choose `Public`, `Unlisted`, or `Private`

![Social AI Composer YouTube Preview](img/Social-marketing-composer-YouTube-Preview.png)
...
* Resolution: 240×240 (min) to 4096×2304 (max)
...
![Social AI Composer Customize By Account](img/Social-marketing-composer-Customize-By-Account-Preview.png)

## Editing Drafts and Scheduled Posts

1. Go to `Social AI` → `Posts` → `Drafts` or `Scheduled`.
...
![Social AI Composer HashTags](img/Social-marketing-composer-HashTags.png)
...
![Social AI Composer Tagging](img/Social-marketing-composer-Tagging.png)
...
![Social AI Composer Link Preview](img/Social-marketing-composer-Link-Preview.png)
...
<details>
<summary>Can I publish YouTube videos from the platform?</summary>

Yes. You can upload videos to YouTube and set titles, privacy settings, and scheduling options from the Composer.
