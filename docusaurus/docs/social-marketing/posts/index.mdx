...
- Use AI to generate post content and images
...
3. Select the social accounts you want to post to under `Post to`.
4. Write your content or use `Write with AI` to generate post text.
5. Add images or videos, or use `Stock Imagery` or `Generate Image with AI`.
6. Choose `Post Now`, `Schedule`, or `Save as Draft`.
