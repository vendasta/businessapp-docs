...
sidebar_label: Long-form blog content
description: "Learn how to create and publish long-form blog content through Social AI"
sidebar_position: 10
---

Social AI allows you to create and publish long-form blog content directly from the platform, making it easy to share detailed content with your audience.

## Creating long-form blog content

1. **Access Blog Creation**: Go to `Social AI` → `Posts` → `Create Content`
...
:::tip
Long-form blog content helps you provide detailed information to your audience.
:::