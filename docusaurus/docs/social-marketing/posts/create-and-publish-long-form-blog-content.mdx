...
When you generate AI images in long-form blog workflows, these limits apply:

- Up to **50 AI images per day**
- No per-minute image generation cap
- Limits can scale based on supported API capacity
- The same limits apply in web and mobile
