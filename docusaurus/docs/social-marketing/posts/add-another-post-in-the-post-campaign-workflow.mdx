...
![Post Campaign Workflow navigation screen](img/add-another-post/post-campaign-1.png)  
2. Enter a topic or subject for the posts.  
![Post Campaign Topic](img/add-another-post/post-campaign-2.png)  
3. Choose the social network where the posts will be published.  
![Post Campaign Social Network Selection](img/add-another-post/post-campaign-3.png)  
4. Select how many posts to generate initially (3, 6, 9, or 12), and set the content length and tone.  
![Post Campaign Number of Posts](img/add-another-post/post-campaign-4.png)  
5. The AI will generate your first set of posts.
![Post Campaign Generated Posts](img/add-another-post/post-campaign-5.png)  
