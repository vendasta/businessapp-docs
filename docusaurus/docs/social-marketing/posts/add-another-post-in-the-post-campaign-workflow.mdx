---
title: Add Posts to Campaigns
sidebar_label: Add to campaigns
description: Use AI to generate additional posts within a Post Campaign without restarting the workflow.
tags: [social, ai, campaigns, post-creation]
keywords: [add another post, ai content generation, post campaign workflow]
---

## What is the add post feature?

The `Add Another Post` feature allows you to generate additional AI-created posts directly within the Post Campaign workflow. You can go beyond the preset options of 3, 6, 9, or 12 posts, up to a maximum of 20 posts per campaign, without restarting the process. This makes it easier to create more content within a campaign.
...
- Integrates with the existing campaign content  

## How to use the add post feature

1. Go to your dashboard and navigate to `Create` → `Post Campaign Workflow`.
![Post Campaign Workflow navigation screen](img/add-another-post/add-another-post-post-campaign.png)  
2. Enter a topic or subject for the posts.  
![Post Campaign Topic](img/add-another-post/add-another-post-post-campaign-topic.png)  
3. Choose the social network where the posts will be published.  
![Post Campaign Social Network Selection](img/add-another-post/add-another-post-post-campaign-social-network.png)  
4. Select how many posts to generate initially (3, 6, 9, or 12), and set the content length and tone.  
![Post Campaign Number of Posts](img/add-another-post/add-another-post-post-campaign-number-of-posts.png)  
5. The AI will generate your first set of posts.
![Post Campaign Generated Posts](img/add-another-post/add-another-post-post-campaign-generated-posts.png)  
6. To add more posts, click `Add Another Post` in step 2 of the workflow.  
![Post Campaign Add Another Post Button](img/add-another-post/add-another-post-post-campaign-add-another-post-button.png)  
7. The AI will generate additional posts based on your topic from step 1.  
![Post Campaign Add Another Post AI Content Generation](img/add-another-post/add-another-post-post-campaign-add-another-post-ai-generation.png)  
8. You can repeat this process until you reach the maximum of 20 posts.
![Post Campaign screen showing 20 posts generated](./img/add-another-post/add-another-post-post-campaign-add-another-post-20-posts-generated.png)  
