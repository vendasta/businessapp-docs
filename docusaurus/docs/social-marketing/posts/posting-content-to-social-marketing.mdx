---
title: Posting Content to Social AI
sidebar_label: Posting content
description: Learn how to post content to social accounts using Social AI
sidebar_position: 5
tags: [social-ai, post-creation, publishing, setup]
keywords: [post social content, schedule social posts, social media publishing, create social posts, social ai guide]
---

# Posting Content to Social AI

Social AI allows you to create and share content to your business's social accounts. This guide will walk you through the process of creating and publishing social posts.

## Accessing Social AI

Access Social AI from Business App:

1. Navigate to Social in the sidebar
2. Click the "Launch" button to open Social AI

![Launch Social AI through Business App](img/launch-sm.png)
...
![Save platforms as default in Social AI](img/default.png)
...
<details>
<summary>What happens if I post to a disconnected account?</summary>

The post will fail to publish. You will receive a notification in the Activity or Posts tab, prompting you to reconnect the account and retry the post.
