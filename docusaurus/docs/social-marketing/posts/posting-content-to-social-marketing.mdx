...
sidebar_position: 5
tags: [social-marketing, post-creation, publishing, setup]
keywords: [post social content, schedule social posts, social media publishing, create social posts, social marketing guide]
---
...
1. In the **Composer**, select the accounts you want to post to from the list in the dropdown menu
