---
title: Using Images in Social AI
sidebar_label: Using images
description: A complete guide to uploading, generating, and optimizing images in Social AI
sidebar_position: 6
---

# Using Images in Social AI

Creating visually engaging posts is key to improving social media performance. This guide explains how to use royalty-free images, AI-generated graphics, carousels, Instagram Stories, and more — all within Social AI.
...
- You can generate up to **50 images per day**.
- Per-minute generation is managed dynamically based on API capacity.
- These limits apply in Social AI on both **web** and **mobile**.
...
![Create image with AI in Social AI](img/ai-image.png)
...
<details>
<summary>Which AI model generates images?</summary>

Social AI uses GPT Image 1 to generate images.
</details>