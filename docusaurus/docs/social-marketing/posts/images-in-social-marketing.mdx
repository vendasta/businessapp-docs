...
In Social Marketing, you can generate up to **50 AI images per day**.

- There is no per-minute AI image generation cap.
- Image generation is available in Social Media Manager and long-form blog workflows.
- The image limit can scale based on supported API capacity.
- These limits apply in both web and mobile experiences.
...
Social Marketing image generation uses GPT Image 1.
</details>