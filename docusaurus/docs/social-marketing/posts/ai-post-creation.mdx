...
Social Calendar Generation creates a scheduled weekly content plan using default settings you can adjust before saving.

The Social Media Manager creates and publishes on-brand social media content to drive awareness, engagement, and leads. It drafts, schedules, and posts on your behalf, tailored to your goals and audience.

### Default setup

When you open Social Calendar Generation, these defaults are pre-filled:
...
- **Day:** `Monday`
- **Time:** `9:00 AM`
- **Time zone:** Your business time zone from Business App
- **Start date:** Today
- **End date:** `No end date`

These defaults apply to the Social Media Manager on web and mobile.
