---
title: AI Post Creation in Social AI
sidebar_label: AI post creation
description: Learn how to use AI tools in Social AI for creating localized content, editing posts, and running campaigns efficiently.
sidebar_position: 4
tags: [social-ai, ai, post-creation, automation]
keywords: [AI post creator, social media automation, content generation, AI localized content, social ai tools]
---

Social AI’s AI tools help streamline content creation across single and multi-location businesses. Whether you’re building one post or orchestrating a full campaign, AI enhances efficiency, consistency, and brand alignment. From localized content generation to interactive editing and campaign-level automation, this article outlines every feature, step, and capability built into the AI experience.
...
When managing multiple business locations through Social AI, AI can automatically generate content that is specific to each location. This ensures consistency in brand voice while tailoring messaging to the local audience of each branch.
...
Social AI’s AI text generation feature can be used directly within the post composer interface. It helps you quickly create social media posts that match your voice, message, and target audience.
...
In Social AI Pro, AI can help you fine-tune content through a **chat-style interface**. Instead of modifying rigid fields or creating a new prompt, you can have a conversation with AI to iterate and improve your content.

### How to Use Conversational AI

1. **Navigate to Social AI** on the account where you wish to post.
2. **Click “Compose”** or **create a single post** in the Social Composer for a single location.
3. **Social AI Pro Required**: You must have the Pro version to access AI features.
...
## Configure Social Media Calendar and Configure Blog Calendar

The Configure Social Media Calendar capability (Social Media Manager) and Configure Blog Calendar capability (Blogger) create a scheduled weekly content plan using settings you can adjust before saving.

### Default setup

When the capability is set up for your business, these fields are pre-filled:

- **AI model:** `Gemini Flash Latest` (recommended)
- **Schedule type:** `On a schedule`
- **Frequency:** `Weekly`
- **Day:** The day of the week Social Premium is activated for your business
- **Time:** `9:00 AM`
- **Time zone:** Your business time zone from Business App. If no business time zone is available, the schedule uses Chicago time.
- **Start date:** The date Social Premium is activated for your business
- **End date:** `No end date`

These settings apply to the Social Media Manager and Blogger on web and mobile.

## Post campaigns: Bulk create using AI

With Social AI’s campaign builder, you can use AI to **generate entire post campaigns in bulk**. This feature is ideal for promotions, seasonal events, product launches, and other coordinated content efforts.

### Creating bulk post campaigns

1. **Access Campaign Creator**: Navigate to Social AI > Posts > Create Campaign.
...
Social AI’s AI capabilities empower users to:
...
These tools are accessible through the Social Composer and Campaign interfaces, available to users on the Social AI Pro plan.

Whether you're writing one post or launching hundreds, Social AI’s AI gives you full creative control while removing the repetitive legwork.
