...
Social Calendar Generation creates a scheduled weekly content plan using settings you can adjust before saving.

### Default setup

When Social Calendar Generation is set up for your business, these fields are pre-filled:
