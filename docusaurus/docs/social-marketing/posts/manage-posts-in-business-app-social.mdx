...
- **Date Range** –  
  - Drafts: Filter by each post's updated date.
  - Published: Filter by past date ranges.
...
:::warning
- You **cannot edit post content** for draft or scheduled posts within Business App.  
  To make content edits, open the post in **Social Marketing**.  
...
You can schedule draft posts and delete posts in Business App. To edit post content, open the post in Social Marketing.
</details>
...
You can filter posts by social network, connected account, or date range. In the `Drafts` tab, date filtering uses each post's updated date.
</details>
