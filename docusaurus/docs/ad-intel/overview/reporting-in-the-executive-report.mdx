...
**Phone Calls** - the number of times people called your call tracking number. (If Call Tracking add-on purchased for the advertising campaign in question.) For more information, [please click here](../faqs/connect-call-tracking.mdx)
