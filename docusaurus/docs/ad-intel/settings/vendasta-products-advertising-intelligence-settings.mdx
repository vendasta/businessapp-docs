...
sidebar_label: Admin vs user settings
...
In Advertising Intelligence, two levels of settings control how the product functions:
...
Only users with the Admin role can access admin settings. These settings control account-wide configurations and determine which features are available to all users within your organization.
...
![Admin Settings access](img/admin-access-1.jpg)

If you don't have admin privileges, you won't see the Admin Settings option.

### Available Admin Settings

The Admin Settings page lets you configure:

- **Account-wide defaults**: Set default values that apply to all users
...
![Admin Settings panel](img/admin-access-2.jpg)

### Admin Dashboard

The admin dashboard provides a comprehensive view of account performance:

![Admin dashboard](img/admin-access-3.jpg)

### Admin Access Control

Admins control which users have access to specific features:

![Admin access control](img/admin-access-4.jpg)

## User Settings

User settings apply only to the individual user's experience within Advertising Intelligence. These settings let users customize their own experience without affecting other users.
...
![User Settings access](img/user-access-1.jpg)

### Available User Settings

The User Settings page lets individual users configure:
...
![User Settings panel](img/user-access-2.jpg)

### User Dashboard Customization

Each user can customize their own dashboard layout:

![User dashboard customization](img/user-access-3.jpg)
