...
With the Advanced Reporting add-on, users can connect individual Ad Campaigns to their Advertising Intelligence account. This feature allows you to selectively display specific campaigns in your reporting table, making it ideal for multi-location businesses or advertisers who want to show clients only the campaigns relevant to their business or specific location.
