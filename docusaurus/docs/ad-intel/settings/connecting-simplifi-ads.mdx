...
- You have the `Application Key` and `User Key` from Simpli.fi
...
<!-- TODO: recapture with current Advertising Intelligence branding (shows outdated megaphone logo) -->
![Advertising Intelligence Connection Settings](img/simplifi-connect.jpg)

### 2. Connect to Simpli.fi

Find and click on the `Simplifi Ads` network tile in the list of available ad networks.
...
- `Application Key`: This key identifies your Simpli.fi application
- `User Key`: This key authenticates your access to the Simpli.fi API
