...
To configure your Conversion metric settings, open **Advertising Intelligence** and navigate to the **Settings** page. Then, click the **Conversion Metrics** section under Google Ads or Facebook Ads to configure the settings for that platform. The option you select supplies the data for the Conversions metric in Advertising Intelligence.
