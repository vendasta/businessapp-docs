...
description: Learn how to connect your TikTok Business account to Advertising Intelligence to gain valuable insights into your TikTok Ads campaign performance.
...
**Conversion Tracking (For Admins):** As an admin, you can select and view conversion metrics to track how effectively TikTok Ads drive desired actions.
