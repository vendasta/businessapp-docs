...
4. In the dropdown menu, select the conversion metrics you want to display for this account. Website Conversions is selected as the default conversion to display.
