...
1. Navigate to `Reputation Management > Listings > Primary Listings`.
...
- **For new listings**: If you recently created a listing, Reputation Management should pull it in during its next search.
