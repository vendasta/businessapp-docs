...
![Review Request Step 1](/img/administration/automations_template_review_request_one.png)

**Step 3:** Next, add an action. In this example, the action is `Send a review request`.

![Review Request Step 2](/img/administration/automations_template_review_request_two.png)
...
![Review Request Step 3](/img/administration/automations_template_review_request_three.png)
...
![Review Request Step 4](/img/administration/automations_template_review_request_four.png)
