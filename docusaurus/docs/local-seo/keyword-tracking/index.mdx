...
<details>
<summary>Can I bulk upload keyword rankings from a spreadsheet?</summary>

No. Keyword Tracking does not support bulk ranking uploads from spreadsheets or cloud storage. Add or change keywords directly in the product. After you add or change a keyword, ranking data usually starts populating within 10 to 15 minutes. If bulk upload is something your business needs, submit product feedback through the in-app feedback option.

</details>

<details>
<summary>How do I track rankings for a specific city?</summary>

Include the city (and region when helpful) in the keyword itself, for example `digital marketing Greensboro, NC` or a `near me` variant you care about. Map pack results and organic results can differ, and Google updates are not instant, so allow time after you change keywords or listings.
