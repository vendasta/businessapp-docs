...
The map radius will default to 1.25 miles but can be easily changed by clicking on the "Edit Keywords" button in the top right. Choose from 1.25, 2.5, 5, 10, 30 or 50 miles for larger cities.
</details>
