...
Citation Builder is an add-on that sends your business information to major data providers (aggregators) so your listing appears accurately across the web—on search engines, mobile apps, voice search, and other platforms. It helps more customers find you, keeps your name, address, phone, and hours consistent everywhere.

:::info
Related products:
- For instant syncing to a focused network of directories, see [Listing Sync Pro](../listing-sync/listing-sync-pro-overview.mdx).
- For listing setup and sync details inside the product, see [Listing Sync](../listing-sync/index.mdx).
:::
...
<details>
<summary>Who is Citation Builder for?</summary>
...
<details>
<summary>How is this different from syncing to Google or Bing?</summary>

Syncing connects you directly to specific platforms (e.g. Google Business Profile, Bing). Citation Builder focuses on data providers that feed many other places (apps, voice search, directories). Both help your business appear in more places; Citation Builder broadens reach through those aggregators.
</details>
