...
- **Time savings**: Update your business information once in your Business Profile, and it syncs automatically across Google, Facebook, Bing, X, and other directories. You no longer need to manually update each platform separately.
...
If a new, accurate Bing listing is created for your business, any older listing marked as "Potentially removed" is removed automatically — no action is needed on your part in that case.

For other duplicate listings on Bing, you cannot suppress them directly, but you can suggest an edit to downgrade and possibly remove them:
...
If a new, accurate Bing listing is created for your business, any older listing marked as "Potentially removed" is removed automatically. For other duplicates, you cannot suppress them directly — use Suggest an edit on the listing and select Remove this place to mark it as closed, nonexistent, or duplicate.
