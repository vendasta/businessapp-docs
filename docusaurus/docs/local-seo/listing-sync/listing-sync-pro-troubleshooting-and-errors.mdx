...
If you see an activation error indicating the account has an existing incompatible service, the existing relationship with the network must end before activation can proceed. You must contact the network’s support address to request termination of the conflicting relationship.
