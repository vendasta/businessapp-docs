...
keywords: [submitted to source, aggregator, duplicate suppression, blocked categories, incompatible service, invalid business name, emoji business name]
---
...
## Activation error: invalid business name

If you see an `Invalid business name` error during activation, update the business name in `Business Profile` to remove emojis, then try activation again.

- Use plain text in the business name.
- Keep the name in a standard format with letters, numbers, and regular punctuation.
