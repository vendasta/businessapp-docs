---
title: Overview
description: "Overview of Local SEO in Business App: business profiles, listing sync, keyword tracking, analytics, Citation Builder, My Listing, and plan comparison."
sidebar_position: 1
...
kb_id: KB-00112
answer_snippet: "Local SEO in Business App keeps your business information accurate everywhere it appears online, including maps and navigation apps, so customers can find you. You can manage your business profile, sync listings, track keywords, and review local search analytics."
doc_owner: local-seo
...
Local SEO in Business App keeps your business information accurate everywhere it appears online, including maps and navigation apps, so customers can find you. You can manage your business profile, sync listings, track keywords, and review local search analytics.

Local SEO lets you customize search engine-optimized listings, view the status of your business listings, sync business information to reputable listing sites, track keyword performance, and analyze your local search presence.
...
- **Service area settings**: Hide physical addresses for service area businesses, or add service areas your business covers.
...
- **Apple Business**: Dedicated connection to Apple Maps and Apple services
...
## How do I get started with Local SEO? {#how-to-get-started-with-local-seo}

For a step-by-step walkthrough, see [Getting Started with Local SEO](../getting-started-with-local-seo.mdx).
...
5. Once connected, turn on sync to keep your business data consistent across platforms.
...
## How do I manage my local SEO presence? {#managing-your-local-seo-presence}
...
- Write clear business descriptions using AI assistance when available
...
## How do the Local SEO plans compare? {#plan-comparison}

| Feature | Local SEO | Local SEO Pro | Citation Builder | Listing Sync Pro |
| --- | :---: | :---: | :---: | :---: |
...
| Sync to Google, Facebook, Apple, Bing, X, and Instagram | — | ✓ | — | — |
...
<details>
<summary>What's the difference between Local SEO Pro and Listing Sync Pro?</summary>

Local SEO Pro provides syncing to Google, Facebook, Bing, Apple and X. Listing Sync Pro uses Yext's network to reach additional directories and provides enhanced reporting and features.
</details>
...
First claim your business through Apple Business, then use the Apple card in Listing Sync to authenticate using OAuth. You'll sign in to Apple Business and select your business entity.
</details>
...
Claimed listings cannot be managed through Listing Sync Pro. Contact the listing platform, or whoever currently manages the listing, to request that it be released so it can sync through Listing Sync Pro.
</details>

<details>
<summary>Is Local SEO available for businesses outside the United States?</summary>

Most features work internationally, but Citation Builder is available only for US-based businesses. Check specific feature documentation for international availability.
</details>
