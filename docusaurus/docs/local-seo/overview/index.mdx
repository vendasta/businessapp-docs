...
- **Conversational AI chat**: Get AI-powered insights about your local search performance
- **AEO Audit**: Evaluate your website's AI Engine Optimization readiness on demand, once per calendar month
- **Inline results**: View audit results directly in the chat, including a relative run date
...
5. Once connected turn on sync to get business data consistent across platforms.
...
| AI Search Specialist (AEO Audit) | — | ✓ | — | — |
...
Claimed listings cannot be managed through Listing Sync Pro. Contact the listing platform or current service provider to request release of the listing to enable syncing functionality to the source through Listing Sync Pro.
</details>
