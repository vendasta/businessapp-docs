---
title: Schedule
description: Learn how to schedule meetings with CalendarHero using personal scheduling links, the web scheduler, or email plugins.
---
...
Each [meeting type](../settings/meeting-types) has its own scheduling link, so the settings for that meeting type (duration, availability, location, questions) apply automatically when someone books through it. You can also embed your scheduling link directly on your website.
