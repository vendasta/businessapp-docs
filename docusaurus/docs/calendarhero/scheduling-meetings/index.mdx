...
Yes. In the web scheduler, use the `Specific Date` option to select the exact date and time you want. The meeting is booked immediately and all invitees receive a confirmation and calendar invite. No time selection step is required.
