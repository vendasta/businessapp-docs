...
Shared availability is available on the Professional plan (with Collaborators) and the Team plan (with Members and Collaborators).
...
Group classes are available on the Professional and Team plans. Group Class is not compatible with iCloud or Exchange On-Premises calendars.
