---
title: How do I limit the number of meetings per day?
sidebar_position: 27
---
...
By default, there are no meeting limits set for your meeting types. To add a meeting limit go to your [Meeting Type](https://faq.calendarhero.com/hc/en-us/articles/4430391446043) open 'Availability' and enter a meeting limit total in the *Meeting Limits* field. For example, if you wanted to avoid scheduling more than 3 meetings associated with that meeting type in a single day - then you would enter "3" as the meeting limit.
