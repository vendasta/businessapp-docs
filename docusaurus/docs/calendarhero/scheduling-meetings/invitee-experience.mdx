...
<details>
<summary>Can I hide invitee email addresses from the meeting invitation?</summary>

No. CalendarHero does not support hiding invitee email addresses. All invitee email addresses are visible to other attendees in meeting invitations. This is a platform limitation with no current workaround.
