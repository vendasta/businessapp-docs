...
<details>
<summary>How often does CalendarHero sync with my calendar?</summary>

CalendarHero syncs with your connected Google or Microsoft calendar in real time. Any change you make in your calendar — adding, moving, or deleting an event — is reflected in CalendarHero immediately. New meeting bookings are also added to your calendar right away.
