...
Azure AD can only be added by a team plan admin from the [Team Integration Directory](https://app.calendarhero.com/org/accounts/add). If you're not a team plan admin, you can't add this integration on your own.
...
If you use Microsoft 365, signing in with "Sign in with Microsoft" at [calendarhero.com/start](https://calendarhero.com/start) is the recommended approach. No manual Exchange configuration is needed.
