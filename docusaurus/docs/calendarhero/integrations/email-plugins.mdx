...
The CalendarHero Gmail add-on adds a scheduling sidebar to your Gmail inbox. It requires a CalendarHero account. Sign up at [calendarhero.com](https://calendarhero.com) if you haven't already.
...
You can install the plugin yourself by adding a custom add-in to Outlook using the CalendarHero manifest URL.
