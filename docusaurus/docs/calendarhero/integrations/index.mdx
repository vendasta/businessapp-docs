...
<details>
<summary>Can I connect CalendarHero to Zoho Calendar?</summary>

No. CalendarHero does not support Zoho Calendar. Native calendar integrations are limited to Google Calendar and Microsoft Calendar. If you use Zoho Recruit, that is supported as an ATS integration — go to the [Integration Directory](https://app.calendarhero.com/settings/accounts/add) and search for Zoho Recruit to add it.
