...
description: Learn how to connect a Google Business Profile account in Reputation AI, Settings, or Local SEO.
...
## To authenticate a Google Business Profile account in Reputation AI

1. Go to the `Listings` tab of Reputation AI.
2. Click the Google listing. In the dropdown, click `View Possible Matches`.
3. Click `Connect Google Business Profile`.

![Connect Google Business Profile in Reputation AI](./img/gbp-connect-rep-management.png)

4. Log into your Google account and select a location (this location must be verified on Google).

## To authenticate a Google Business Profile account in Reputation AI Settings

Connect a Google Business Profile account in `Reputation AI` → `Settings` → `Connect Accounts`

![Connect Google Business Profile in Reputation AI Settings](./img/gbp-connect-rep-settings.png)
...
7. Changes to location info in Business App automatically syndicate to Google Business Profile.
