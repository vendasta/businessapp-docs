...
Each listing source is assigned a score based on its popularity and authority. Popular sites like Google Maps carry more weight. We assess the accuracy of your listings on the top 30 sites and adjust the score accordingly:
