...
The `address` dynamic field follows your [Business Profile](../../business-app/administration/business_profile.mdx) settings, unless you've set an override in [Email Configuration](../../business-app/administration/email/email-configuration.mdx):
