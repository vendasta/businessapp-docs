...
The `address` dynamic field follows your Business Profile settings. If `Service area business` is off, it inserts your `Physical address`. If `Service area business` is on, it inserts your service area instead, or leaves out the address if there's nothing to show.
