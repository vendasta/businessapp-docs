...
With SMS template management, you can create and organize custom templates tailored to your specific communication needs for review and NPS requests. Personalized templates help increase response rates and strengthen your ability to manage your online reputation through timely, relevant customer interactions.
...
- **Edit:** When you click `Edit`, you will be redirected to the SMS builder with the current template's configurations pre-loaded. You can make any necessary changes and then save the updated template.
- **Delete:** When you select `Delete`, a confirmation pop-up will appear with two choices: `Confirm Delete` or `Cancel`.
  - **Confirm Delete:** If you click `Confirm Delete`, the template will be permanently deleted from the system.
  - **Cancel:** If you click `Cancel`, the pop-up will close, and you will return to the template listing page without making any changes.
...
- Make Default: If you click `Make Default`, that template will be set as the default for SMS requests. The default template is automatically used in automation processes and pre-loaded in the `Request Review` section when sending new review requests via SMS.
...
- You can choose which review source (such as Google or Facebook) you want reviews from when sending a review request.
