...
description: Learn how to send branded review requests to your customers by email or SMS in Reputation AI Premium.
brand: business-app
...
![The Request Review screen showing Send via set to Email and SMS, an empty Send to field, email and SMS template dropdowns under Content, and a live email preview panel on the right.](img/request-review.png)

2. Select the review site(s) where you want to direct customers to leave reviews

![The Request Review screen with the Send to field highlighted, showing the Select recipients button where you choose who receives the review request.](img/select-recipients.png)
