...
- **[Respond to Reviews](respond-to-reviews.mdx)**: Reply to reviews directly from the platform
- **[SMS Review Requesting](sms-review-requesting.mdx)**: Request reviews via SMS (Premium)
- **[Review Widget](customize-the-review-widget.mdx)**: Display reviews on your website
- **[AI-Generated Responses](ai-generated-review-responses.mdx)**: Use AI to draft review responses
- **[Managing Edited Reviews](managing-edited-reviews.mdx)**: Track when customers update their reviews
- **[Review Matching](review-matching.mdx)**: Match reviews to your business listings
- **[Check-in Kiosk](check-in-kiosk.mdx)**: Collect reviews from walk-in customers at your front desk
...
Reviews are listed with the most recently updated review at the top. A review's updated time reflects when it was last edited, or its published date if it hasn't been edited.
