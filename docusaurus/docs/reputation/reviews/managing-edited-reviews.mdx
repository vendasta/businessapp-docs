...
- Editing a review updates its position in the Manage Reviews list, since reviews are listed by most recent update

## Frequently Asked Questions

<details>
<summary>If a customer edits an old Google review, will AI update the existing response?</summary>

Editing a review re-triggers AI. If the existing reply was posted directly on Google by the business owner, Google does not allow the platform to overwrite it, so only the original author can change that reply. If the original reply was posted through the platform, AI can auto-publish an updated response.

</details>

<details>
<summary>When a customer edits a review, will the AI agent automatically respond or create a draft?</summary>

When the AI reputation specialist is enabled, edited reviews are handled automatically. The agent either posts a response or creates a draft based on your configured settings.
