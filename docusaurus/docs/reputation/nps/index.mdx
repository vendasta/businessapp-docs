...
1. Open the `ML Data Exporter` tab.
2. In the data dropdown, select `NPS`.
3. Review the NPS table. The table columns update for NPS data.
4. Apply filters as needed:
   - Use the same filter controls used for reviews data.
   - In single-location view, use the `Page` filter to narrow the results.
