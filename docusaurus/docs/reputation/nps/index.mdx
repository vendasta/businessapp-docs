...
NPS feedback entries also appear in the `Inbox` timeline in `Conversations` as system activity for the related contact. This gives you one place to track scores, comments, and other conversation activity.
