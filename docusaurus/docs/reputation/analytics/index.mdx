...
description: Learn about the analytics features available in Reputation AI
sidebar_position: 1
brand: business-app
...
Analytics in Reputation AI helps you gain deeper insight into how your business is perceived online. By analyzing review content and sentiment, you can identify key themes, track trends, and benchmark your performance against competitors.
...
- **[Request Performance Metrics - Single Location](request-performance-metrics-single-location.mdx)**: Track review request performance for individual locations
- **[Request Performance Metrics - Multi-Location](request-performance-metrics-multi-location.mdx)**: Compare metrics across multiple business locations
- **[Competition: Share of Voice](competition-share-of-voice.mdx)**: Benchmark your reputation against competitors
- **ML Data Exporter**: Export reviews or NPS data with table-based filtering

## Get started

1. Go to the `Reputation AI` dashboard.
...
## Export reviews and NPS data

You can use the `ML Data Exporter` tab to review and export reputation data.

1. Go to `Reputation AI` > `Analytics` > `ML Data Exporter`.
2. In the data type dropdown, select `Reviews` or `NPS`.
3. Review the table for the selected data type.
4. Apply filters to narrow the results. When you select `NPS`, you can use the same filter behavior available for reviews, including the `Page` filter in single-location view.
5. Export the filtered data from the exporter page.
...
Filtering options depend on the configuration of your Reputation AI dashboard. Check for filters at the top of the analytics page.
</details>
...
Yes. Go to `Reputation AI` > `Analytics` > `ML Data Exporter`, then choose the data type you want to export.
</details>
