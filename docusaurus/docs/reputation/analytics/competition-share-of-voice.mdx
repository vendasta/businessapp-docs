---
title: "Competition: Share of Voice in Reputation AI"
sidebar_label: "Competition: Share of Voice"
description: "Learn how to use Share of Voice in Reputation AI to analyze your business's mentions compared to competitors"
tags: [reputation-ai, competition, analytics, share-of-voice]
keywords: [competitor share of voice, local search competition, Reputation AI analytics, Reputation AI share of voice, compare business mentions, rank tracking]
brand: business-app
...
In `Reputation AI` go to `Analytics` → `Competition`.
...
- The search terms you have entered may be too general. If you own a pizzeria in New York, you may have a 0% Share of Voice for "Restaurant + New York" but a significantly higher share for "Pizza + New York."
- Check if the company name you have entered is too specific. If you enter your business name as "Andrea's New York Style Pizzeria", Share of Voice will search for results where those exact words appear. You may have more luck searching for "Andrea's Pizzeria" or just "Andrea's."
...
<details>
<summary>Why did my share of voice drop suddenly?</summary>

This could happen if a competitor launched a new campaign, if your listing temporarily disappeared from a search result, or if the search engine algorithm shifted its ranking priorities.

</details>

<details>
<summary>Does this track paid ads or just organic results?</summary>

Share of Voice in this context primarily measures **organic** visibility in local search and map packs and *not* paid ad impressions.
