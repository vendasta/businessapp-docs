...
Click `My Products`, then click the **pin icon** in the top-right of each product card to choose which products appear on the Business App side panel. You can set your own pins.

![Pin icon to organize products](img/my-products-2.png)

For more detail on configuring and pinning products, see [Configuring My Products](./configuring-my-products).
