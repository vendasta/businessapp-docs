...
- **Listing Precision**: How strict or relaxed that listing accuracy is measured (this varies by account).
...
- **Use the Executive Report**: If you don't see a score or section, some sections may not be visible depending on your account setup.
...
They appear in your **Executive Report**. If you don't see them, some sections may not be visible depending on your account setup.
