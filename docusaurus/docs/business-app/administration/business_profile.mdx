...
sidebar_position: 2
description: Learn how to manage your Business Profile, including your business details, hours, descriptions, images, social links, and attributes.
brand: business-app
...
You can open this page by going to `Administration` → `Business Profile`.
...
`Business name` is the only required field on the Primary Info tab. `Website URL`, `Primary business category`, `Physical address`, and `Phone number` are marked as recommended — you can save your profile without filling them in.

If you leave a recommended field blank and click `Save`, Business App shows a warning that lets you continue saving as-is or go back and edit the remaining fields. Choosing to go back highlights the incomplete recommended fields so you can find them quickly.

If a recommended field already contains saved information and you clear it, that field becomes required again — you won't be able to save the profile until you fill it back in. This prevents you from accidentally removing information that other products or services on your account may already be using.

## Primary operating language

The `Primary operating language` field controls the language used for outgoing booking notifications — the [My Meetings](../crm/My meetings/index.md) confirmation and reminder emails and SMS messages sent to your customers.

![Primary operating language dropdown on the Business Profile page](img/primary-operating-language.png)

This field is empty by default, and notifications go out in English until you set a language. Supported languages include Danish, Dutch, Dutch (Belgium), English, English (Australia), English (Canada), and others available in the dropdown.

:::note
This is different from [booking page language](../crm/My meetings/index.md#booking-page-language), which automatically translates the booking page itself based on your customer's browser — no setup required. Primary operating language only affects the language of confirmation and reminder messages sent after booking.
:::
...
![Business Profile Descriptions tab showing short and long description fields](img/administration-descriptions.png)
...
When your profile data syncs, AI Employees can also use your Business Profile attributes as part of your [Knowledge Base](/business-app/ai/knowledge-base).

### Examples of available attributes

Depending on your business type, you can select attributes such as:
...
`Business name` is the only field you must always fill in. For recommended fields like `Website URL`, `Primary business category`, `Physical address`, and `Phone number`, you can save your profile with them blank, but you'll see a warning first — missing information may reduce your visibility in listings and create gaps in reporting or customer-facing tools. If one of these fields already has information saved and you remove it, you'll need to fill it back in before you can save.
