...
1. **Welcome new contacts**: Contact created → Send welcome email → Create follow-up task
2. **Lead nurturing**: Contact created → Send campaign series → Log activity based on engagement
3. **Payment follow-up**: Payment failure → Notify your team → Create follow-up task
4. **Opportunity management**: Opportunity created → Update contact → Create a sales task
5. **Review collection**: Transaction completed → Delay 2 days → Send review request
