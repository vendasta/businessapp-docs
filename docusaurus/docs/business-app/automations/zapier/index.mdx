...
|---|---|---|
| **Business App → Zapier** | Use the `Send a webhook` step in your Business App automation to push data out to Zapier | Opportunity marked as won in Business App → create a new customer in QuickBooks Online |
...
- [Zapier → Business App](./zapier-triggers-business-app.mdx): an event in another app fires one of your automations
- [Business App → Zapier](./business-app-triggers-zapier.mdx): an automation step pushes data out to Zapier
