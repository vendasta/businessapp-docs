...
**Actions you can use:**
- **[Messaging actions](action-messaging.md)** - Send SMS, email, and WhatsApp messages
- **[Campaign actions](action-campaigns.md)** - Pause campaigns intelligently

**Complete workflows:**
- **[Review request automation](use-case-review-requests.mdx)** - Collect customer reviews automatically
