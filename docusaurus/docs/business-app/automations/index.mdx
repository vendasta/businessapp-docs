...
- **[Set up messaging](messaging.md)** - Send SMS or email notifications
- **[Explore templates](templates-and-recipes.md)** - Browse pre-built automation workflows
- **[Connect with Zapier](zapier.md)** - Integrate with thousands of external apps
