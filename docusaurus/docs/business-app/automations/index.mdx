---
title: Automations
description: "Build Business App automations with triggers, conditions, and steps, turn them on or off, and run them on selected CRM contacts and companies."
sidebar_position: 1
brand: business-app
product: automations
audience: smb
...
kb_id: KB-00151
answer_snippet: "Automations in Business App run workflows on their own when specific events happen. Each automation has a trigger that starts it, optional conditions that filter when it runs, and steps that define what happens next."
...
Automations in Business App run workflows on their own when specific events happen. Each automation has a trigger that starts it, optional conditions that filter when it runs, and steps that define what happens next. Use them to save time, improve consistency, and respond to customers faster without manual effort.
...
## How do I create an automation? {#getting-started}
...
6. **Edit automation details** — select ``Edit details`` from the side panel to name and organize your automation. Give it a title, add a description (or select ``Regenerate description`` to have AI draft one), apply tags to make it easier to find on the Automations page, and add notes. This description also appears under the trigger name in the automation builder, so anyone viewing the automation can see what it does at a glance.
...
## What happens when I turn on an automation? {#turning-on-an-automation}
...
## What happens when I turn off an automation? {#turning-off-an-automation}
...
## How do I run automations from the CRM? {#run-automations-from-the-crm}
...
- [Review request automation](review-requests.mdx) - Collect customer reviews automatically
...
<details>
<summary>What are the three parts of an automation?</summary>

Every automation has a trigger, the event that starts the workflow; optional conditions, filters that must be met for it to run; and steps, the actions that happen next.
</details>

<details>
<summary>Can an automation create tasks automatically?</summary>

Yes. Add a "Create task" step to your automation. You can also create tasks, notes, and logged calls on opportunities.
</details>

<details>
<summary>Can I edit an automation while it's turned on?</summary>

No. You must turn off your automation before you can edit its triggers, conditions, or steps.
</details>

<details>
<summary>How do I run an automation manually on specific contacts or companies?</summary>

In `CRM` > `Contacts` or `CRM` > `Companies`, select one or more records, click `Actions`, and choose `Start automation`. The automation runs on the records you selected.
</details>
