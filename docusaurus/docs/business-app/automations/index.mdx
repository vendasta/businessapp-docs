...
You'll then be asked to grant permission for the automation to access your account data. This is required for it to run. Select the account you want to activate this automation on and confirm access.
...
- [Messaging steps](workflows/action-messaging.md) - Send SMS and email messages
- [Campaign steps](workflows/action-campaigns.md) - Pause campaigns intelligently
