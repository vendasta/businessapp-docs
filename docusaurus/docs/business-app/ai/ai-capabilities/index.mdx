...
- **Stop AI Response**: Let a customer end an automated chat conversation with a trigger phrase, so the AI says goodbye and stops auto-replying until a team member turns it back on. See [Stop AI Response](../ai-workforce/ai-chat-receptionist/index.mdx#step-2-configure-your-ai-chat-receptionist-capabilities).
...
Yes. In addition to the built-in capabilities, you can build custom capabilities to connect with external APIs, trigger specific workflows, or perform unique business tasks.

</details>

<details>
<summary>Do I need coding skills to use capabilities?</summary>

Built-in capabilities require no coding. Creating custom capabilities often involves working with APIs and JSON, so some technical knowledge or developer assistance may be helpful.

</details>

<details>
<summary>Can multiple AI Employees use the same capability?</summary>

Yes. Capabilities are reusable "skills" that can be assigned to as many AI Employees as needed, ensuring consistent behavior across your workforce.
