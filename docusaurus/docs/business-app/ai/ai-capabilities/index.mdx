...
- **Transfer Call** : Live-transfer callers to other numbers based on intent and rules. See [Transfer calls to other numbers](../ai-workforce/ai-voice-receptionist.md).
...
- **Configure Built-in Capabilities**: [How to Configure AI Capabilities](configuring-capabilities.md)
- **Create Custom Capabilities**: [Creating Custom Capabilities](creating-custom-capabilities.md)
