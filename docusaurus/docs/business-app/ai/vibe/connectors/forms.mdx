...
import projectCard from './img/project-card.png';
import sharedConnectors from './img/shared-connectors.png';
...
On your project card, click **Configure**.

<img src={projectCard} alt="Project card showing Build and Configure buttons" className="img-screenshot" />

On the project settings page, scroll to **Shared connectors** and toggle **Forms** on.

<img src={sharedConnectors} alt="Shared connectors section with Forms enabled" className="img-screenshot" />
