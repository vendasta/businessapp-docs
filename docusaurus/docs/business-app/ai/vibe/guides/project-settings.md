...
description: Configure a Vibe project from one place — general details, business knowledge, connectors, SEO and indexing controls, and code.
tags: [vibe, ai, project-settings, connectors, knowledge, seo]
...
2. Select the section you need — **General**, **Knowledge**, **Connectors**, **SEO**, or **Code**.
