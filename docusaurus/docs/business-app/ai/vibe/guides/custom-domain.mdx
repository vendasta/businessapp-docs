...
Every Vibe project gets a default published URL automatically. On the Standard and Pro plans, you can also publish to a domain you own — including country and regional domains like `.co.uk`, `.com.au`, and `.org.uk`. TLS is provisioned automatically for both your default URL and any custom domain, so you don't need to purchase or manage certificates.
