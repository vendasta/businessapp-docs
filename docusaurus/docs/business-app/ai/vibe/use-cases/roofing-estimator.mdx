...
Before running the prompt, enable the **Forms connector** — open your project's settings and select **Connectors** (see [project settings](../guides/project-settings.md)), then toggle **Forms** on. The contact intake form routes leads to Business App through this connector. If it isn't enabled first, the form will appear in the app but submissions won't be captured.
...
**Add real material and labour costs to Business Knowledge.** The default output uses general pricing approximations. For more accurate estimates, open your project's settings and select **Knowledge**, then add a Note with the client's actual material and labour rates. Once it's there, prompt Vibe to use it:
