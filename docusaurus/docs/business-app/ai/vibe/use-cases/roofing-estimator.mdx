...
**Enable the Forms connector before prompting for a contact intake form.** The Forms connector needs to be turned on in **Project Settings → Shared connectors** before it will route submissions to Business App. If it isn't enabled first, the form will appear in the app but leads won't be captured.
