...
description: Set up your AI Chat Receptionist to capture leads and answer questions 24/7 across web chat, email, SMS, Facebook Messenger, and WhatsApp. Configure purpose, capabilities, and knowledge.
sidebar_position: 2
...
Your AI Chat Receptionist is assigned to the **Web Chat** channel by default. This channel is always active and cannot be disabled. You can also assign your AI Receptionist to additional channels like **Email** and **SMS** to automatically respond to inbound customer messages across all your communication channels.
...
To enable email auto-response, simply enable the Email channel in your AI Chat Receptionist settings. Learn more about [setting up Conversations for Emails](/business-app/conversations/conversations-send-receive-emails).
:::
