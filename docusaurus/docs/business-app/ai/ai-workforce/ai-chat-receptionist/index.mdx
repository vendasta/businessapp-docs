...
description: Set up your AI Chat Receptionist to capture leads and answer questions 24/7 across web chat, email, SMS, Facebook, Instagram, and WhatsApp. Configure role, capabilities, and knowledge.
...
- **Stop AI Response**  
  Let customers end the automated conversation on their own. When a customer's message includes "ai off," the AI sends a short goodbye and then stops auto-replying to that conversation. A team member can turn AI replies back on for the conversation at any time. This works on every channel your AI Chat Receptionist replies on. Add this capability from the capabilities list, and edit its prompt if you want to change the trigger wording.
