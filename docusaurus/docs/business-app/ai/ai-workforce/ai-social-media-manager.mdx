...
:::note
Knowledge sources used by the AI Social Media Manager are shared with **Write with AI** in Social AI. The Social Post Generation Instructions capability governs Write with AI inside Social AI only — it does not affect the standalone Social AI composer.
:::
