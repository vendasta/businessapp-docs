...
description: "The AI Social Media Manager generates, schedules, and publishes a social media calendar across your connected networks in Business App."
...
kb_id: KB-00123
answer_snippet: "The AI Social Media Manager is an AI employee in Business App that generates, schedules, and publishes social posts across your connected networks on a schedule you define. It's available in the Social AI Premium edition for single-location businesses."
...
The AI Social Media Manager is an AI employee in Business App that generates, schedules, and publishes social posts across your connected networks on a schedule you define. It's available in the Social AI Premium edition for single-location businesses.

It generates a full social calendar, writes platform-ready posts, sources or generates images, and drafts, schedules, or publishes content across every connected network. You can also work with it conversationally at any time: generate posts, pull performance data, update drafts, or delete content through a natural language chat interface inside Business App.
...
## How do I set up the AI Social Media Manager? {#how-to-set-up-the-ai-social-media-manager}
...
The AI Social Media Manager includes eight core capabilities that cover the full content lifecycle. Each capability is fully editable and can be configured to match how you want the AI to research, write, illustrate, and publish your posts. You can also add custom capabilities using **+ Add Capability**.
...
:::note
Knowledge sources are shared between the AI Social Media Manager and **Write with AI** in the Social AI composer. The Customize Social Post Instructions capability only governs how the AI Social Media Manager writes posts. It does not change Write with AI in the standalone composer.
:::
...
| --- | --- | --- |
| **Frequency** | Every day, a specific day of the week, or a specific day of the month | Weekly (Mondays) |
...
## How do I work with the AI Social Media Manager in chat? {#working-conversationally}
...
## Can I generate videos in chat? {#generate-videos-in-chat}

:::info Trusted testers
Video generation is available to trusted testers. It isn't available to all Business App users.
:::

Ask the AI Social Media Manager to generate a video for a post directly in chat. Videos render as 8-second clips at 720p in a 16:9 aspect ratio.

Video generation runs asynchronously: you can continue chatting with the AI Social Media Manager while a video renders, and the finished video is inserted into the conversation when it's ready. You can also base a generated video on one of your own photos, so the output reflects your business's real look, and generate the same video concept in a different language.
...
<details>
<summary>Can I stop the AI Social Media Manager from generating content on a schedule?</summary>

Yes. The Social Calendar Generation trigger controls when the AI runs on its own, and you can set an **End date** for the date the trigger stops. You can still chat with the AI Social Media Manager to generate posts on demand.
