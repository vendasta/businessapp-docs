...
3. Set the capability name to `Discovery & Qualification`
4. Set the description to: "Employs a consultative selling framework to transform initial inquiries into qualified leads."
