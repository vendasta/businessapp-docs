...
kb_id: KB-00125
answer_snippet: "The AI Reputation Specialist is an AI assistant in your Business App AI Workforce that automatically responds to Google Business Profile reviews and Facebook recommendations. You can also chat with it to analyze your reviews and Net Promoter Score (NPS) data."
...
The AI Reputation Specialist is an AI assistant in your Business App AI Workforce that automatically responds to Google Business Profile reviews and Facebook recommendations. You can also chat with it to analyze your reviews and Net Promoter Score (NPS) data. Responses follow the rules and knowledge you configure.
...
## How do I set up the AI Reputation Specialist? {#how-to-set-up-the-ai-reputation-specialist}
...
![AI Workforce page showing the Reputation Specialist card with the Configure button highlighted](../img/ai-reputation-specialist-1.png)

1. Go to `AI` > `AI Workforce`
2. Click `Configure` on the AI Reputation Specialist
3. Name your AI and upload an identifying image

![Configure page for the Reputation Specialist showing the profile picture and name field](../img/ai-reputation-specialist-2.png)

This helps you recognize the AI during configuration and activity monitoring.

### Step 2: Understand capabilities

The AI Reputation Specialist has two core capabilities. Each capability serves a different purpose and can be enabled or disabled independently based on your needs.

![Capabilities section listing the Generate Review Response and Explore review and NPS data capabilities](../img/ai-reputation-specialist-3.png)
...
![Generate Review Response capability configuration showing its name, description, and prompt](../img/ai-reputation-specialist-4.png)
...
![Explore review and NPS data capability configuration showing its name, description, and prompt](../img/ai-reputation-specialist-5.png)
...
![Knowledge sources section with the Business Profile source added](../img/ai-reputation-specialist-6.png)
...
![Triggers section showing the New review received trigger with a Settings link](../img/ai-reputation-specialist-7.png)

1. Open `Trigger` > `Settings`
2. Configure the following:

![Trigger settings for star rating, platforms, and response delay when a new review is received](../img/ai-reputation-specialist-9.png)
...
![Trigger settings panel with the Save button highlighted to apply review response settings](../img/ai-reputation-specialist-10.png)
...
![Configure page with the New review received trigger enabled and the Save button highlighted](../img/ai-reputation-specialist-13.png)
...
![AI Workforce page with the Chat button highlighted on the Reputation Specialist card](../img/ai-reputation-specialist-15.png)

![Chat interface for the Reputation Specialist with suggested questions about customer feedback](../img/ai-reputation-specialist-16.png)
...
<details>
<summary>Can the AI Reputation Specialist respond to negative reviews?</summary>

It responds to the star ratings you select in `Trigger` > `Settings`. The default is 4 stars and above, so select lower ratings too if you want it to respond to them.

</details>

<details>
<summary>How do I turn automatic review responses on or off?</summary>

In the `Trigger` section of the AI Reputation Specialist, select or clear the `New review received` checkbox, then click `Save`. When the trigger is enabled, the AI responds to new reviews based on your trigger settings.
