...
This document provides a comprehensive overview of **WhatsApp Coexistence**, a powerful feature that allows your business to use the traditional WhatsApp Business App alongside professional automation tools.
...
* **Dual-Platform Flexibility:** 
  ...
  * **In the platform:** Access advanced features that platform offers and allow your entire team to manage WhatsApp conversations collaboratively.
* **Real-Time Sync:** Messages, history and contacts stay perfectly synced. If you reply from your phone, the message appears in the platform. If a team member or AI bot replies from the platform, it shows up on your phone.

## How to Set It Up (Step-by-Step)

Setting up Coexistence is a seamless process that takes just a few minutes via a QR code scan.
...
2. **Log in flow:** A popup will appear. Log in to your Facebook account to authorize the connection.
   ...
   * **Authorize Access:** Review the permissions and click **Continue** to allow the platform to connect to your WhatsApp Business account.
...
Once connected (this can take some second for the connection to complete), you will see a "Connected" status in the platform. Your phone will continue to function normally, but you will now see all those history conversations (if available) appearing in **Conversations** tab in the platform.
