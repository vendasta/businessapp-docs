...
Once connected (this can take a few seconds for the connection to complete), you will see a "Connected" status in the platform. Your phone will continue to function normally, but you will now see all that conversation history (if available) appearing in the **Conversations** tab in the platform.
