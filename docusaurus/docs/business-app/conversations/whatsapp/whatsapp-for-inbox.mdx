...
The **250** and **1,000** figures are daily messaging limits—the maximum number of business-initiated conversations you can start per day (see [Messaging limits](#messaging-limits) above). Template messages are billed by Meta starting with the first message you send.
