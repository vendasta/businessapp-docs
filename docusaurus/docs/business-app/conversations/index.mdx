...
![Conversations inbox overview](./img/conversations.png)
...
<details>
<summary>How do NPS feedback and review matching events appear in the Inbox timeline?</summary>

NPS feedback and review matching events appear as inbound updates with a Reputation icon in your Inbox timeline.

- NPS feedback uses the title `Contact has submitted NPS survey.`
- Review matching uses the title `Review Matched.`
- Multi-line NPS feedback keeps its line breaks in the timeline.
