...
![Conversations inbox showing channels and message threads](./img/conversations.png)
...
## Reputation activity in Conversations

Conversations also shows Reputation activity in your inbox, including:

- `NPS feedback`
- `Review matched`

When an NPS feedback record is updated, the existing inbox event is updated with the latest details.
...
Conversations does not directly integrate with external CRMs or messaging platforms. However, you can bring data from outside systems into your CRM, and use workflows to send Conversations conversation data to other systems using integrations like Zapier or through custom workflows.
...
Business App Workflows let you create custom workflows using triggers (like a `Message Received`) and actions (such as `Send Email` or `Send SMS`). This helps you automate responses and actions based on specific rules and criteria.
...
<details>
<summary>Why can't I see Conversations AI in Business App?</summary>

Conversations AI visibility is controlled through your account's page settings. If you can't see Conversations AI in your Business App navigation, it may have been hidden by your account administrator. Contact your account administrator or service provider to have it enabled.
