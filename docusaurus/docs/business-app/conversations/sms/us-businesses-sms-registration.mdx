...
On the review step of the form, click **Analyse** to have the AI Verification assistant check your entry. It reviews your campaign details together with the pages you linked — your privacy policy, terms and conditions, and any opt-in or contact forms — then shows you a list of issues by severity, with the specific fix for each one and the affected fields highlighted. This check is optional and doesn't prevent you from submitting your registration.
