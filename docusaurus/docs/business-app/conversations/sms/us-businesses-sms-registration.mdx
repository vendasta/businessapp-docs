...
- That SMS opt-in data and consent are not shared with third parties, excluding aggregators and providers of the text message services
...
Your business registers for both **transactional** and **marketing** messaging.
...
Your campaign description, consent collection, and sample messages must reflect both message types.
...
- **Marketing consent**: Confirms the customer agrees to receive promotional messages such as sales and special offers. **The marketing consent checkbox must not be required to complete the form.** Customers must be able to submit the form without opting into marketing messages.

Both consent checkboxes should clearly state that message and data rates may apply, message frequency varies, and that the customer can reply STOP to unsubscribe or HELP for assistance at any time. Include links to your privacy policy and terms and conditions next to the checkboxes.
...
- **Verbal consent**: If your business collects consent over the phone or in person, describe the script your team uses during that conversation. The script must include the HELP keyword, links to your privacy policy and terms and conditions, and a clear way for the customer to decline.
- **Website chat widget**: If your business uses a chat widget on your website, customers may provide consent to receive SMS messages through the chat interaction. The consent prompt gives customers a clear way to decline and includes links to your privacy policy and terms and conditions.
