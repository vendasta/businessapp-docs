...
Every registration covers both **transactional** and **marketing** messaging, so you don't need to choose between them.
...
- **Verbal consent**: If your business collects consent over the phone or in person, you can provide the script used during that conversation. The script must ask separately for transactional and marketing consent, reference the HELP keyword, and include links to your privacy policy and terms. Because marketing consent must be documented in writing, a customer who agrees to marketing messages verbally must also confirm by replying to a follow-up text message before marketing messages begin.
- **Website chat widget**: If your business uses a chat widget on your website, customers can also provide consent to receive SMS messages through the chat interaction. The widget must give customers a clear way to decline, in addition to links to your privacy policy and terms.
