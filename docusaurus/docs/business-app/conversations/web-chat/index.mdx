...
:::note AI employee availability can vary
The AI employees you can choose from depend on what's available for your account. If **Chat Receptionist** or an AI employee type isn't listed, it isn't available to assign. If no AI employee is available at all, web chat widget setup doesn't appear on the **Conversations settings** page. This doesn't affect any widget you've already installed. It keeps working, and messages still reach your Inbox.
:::
...
2. Paste it into the `<body>` of your webpage, at the exact location where you want the chat to appear.
   - **Divi (WordPress)**: open the page in the Divi Builder → add a **Code module** → paste the full snippet → Save.
