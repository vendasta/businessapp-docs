...
1. Navigate to **Conversations AI ? Conversations AI Settings**.
2. Click **Configure Web Chat**.
3. Select the **GoDaddy Website Builder** tab in the **Installation** section.
4. Copy the custom Javascript code.
5. In your GoDaddy Website Builder, use the option to add **custom code** or an **HTML section** to your site and paste the code.
