...
This is the default method of adding the AI Receptionist to your website. It places a floating button on the bottom left or right corner of your website that allows visitors to start chatting with the AI Assistant.
