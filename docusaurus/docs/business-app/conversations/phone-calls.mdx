---
title: "How do I handle incoming phone calls in Conversations?"
sidebar_label: "Voice AI"
sidebar_position: 5
description: "Handle incoming calls to your Conversations phone number: end, forward, or answer with the AI Voice Receptionist, and send SMS follow-ups."
brand: business-app
product: conversations
audience: smb
content_type: how-to
kb_id: KB-00099
answer_snippet: "Conversations in Business App handles incoming calls to your assigned Conversations phone number. You choose whether to end the call, forward it to another number, or have the AI Voice Receptionist answer it (Premium only), with an optional SMS follow-up."
...
Conversations in Business App handles incoming calls to your assigned Conversations phone number. You choose whether to end the call, forward it to another number, or have the AI Voice Receptionist answer it (Premium only), with an optional SMS follow-up. The features available depend on your Conversations edition.
...
## Which phone call features are included in each edition? {#features}
...
## What do I need to use phone calls? {#what-youll-need}
...
## How do I get started with phone calls? {#getting-started}
...
## How do I use phone calls in Conversations? {#using-phone-calls-in-conversations}

### How do I enable the AI Voice Receptionist (Premium only)? {#enable-the-ai-voice-receptionist-premium-only}
...
- A `New Leads from Conversations AI` notification is sent to everyone on the account who has that notification enabled. See [Notification settings](../administration/notification_settings.mdx)
- Team members can review conversations
- Follow-up actions can be triggered through Automations

### How do I forward my main business number to Conversations (optional)? {#call-forwarding-setup-optional}
...
## How do I troubleshoot phone calls? {#troubleshooting}
...
## What are the best practices for phone calls? {#best-practices}
...
- Monitor call recordings to identify common questions and improve service (Premium)
...
Phone call integration is available for businesses located in the United States and Canada only. This feature requires a Conversations Pro or Premium subscription.
</details>
...
Yes, all team members with access to Conversations can view call recordings, transcripts, and summaries. This enables collaborative follow-up. Call recordings are available with Premium only.
</details>
...
<details>
<summary><strong>What is the difference between Conversations Pro and Premium for phone calls?</strong></summary>

Both editions include a dedicated Conversations phone number, call forwarding from your main business line, and missed-call text back and SMS automation. Premium adds call recordings, transcripts, and summaries in your CRM, plus the AI Voice Receptionist, which answers calls 24/7.
</details>
