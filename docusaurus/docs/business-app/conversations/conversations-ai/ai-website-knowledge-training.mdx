...
sidebar_label: "Knowledge Training"
...
![The AI website knowledge training setup screen showing website URL input and page selection options](../img/inbox/ai-website-knowledge-training.png)
...
3. Follow the wizard to train the AI assistant on your website. Make sure to select all the pages you'd like to train your AI on, and save.
...
<details>
<summary><strong>Why am I having issues with AI scraping my site?</strong></summary>
