...
- Go to `Business App` → `Administration` → `Integrations` → `Browse Integrations`
...
- Go to `Business App` → `Administration` → `Integrations` and click the **Google Search Console** card to edit queries
