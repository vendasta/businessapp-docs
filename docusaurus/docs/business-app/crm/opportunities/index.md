...
- **Value analytics** – total value of opportunities broken down by stage to help you understand your pipeline and forecast revenue
...
Go to `CRM` → `Opportunities`, then click `Set up a pipeline` and follow the prompts. See [Pipeline setup](pipeline-setup.md) for details.
</details>
...
You can close an opportunity via the pipeline view, profile page, or by updating the stage field to `Closed Won` or `Closed Lost`. See [Create, edit, and close opportunities](create-edit-close.md).
</details>
...
Edit from the profile page by clicking the field, or from the table view using the action menu. See [Create, edit, and close opportunities](create-edit-close.md).
</details>
