...
description: Capture in-person meeting audio from the My Meetings page and upload it to the CRM for analysis.
...
You can record audio from in-person meetings directly on the My Meetings page. Once saved, the recording is uploaded to the CRM where it can be analyzed and linked to a contact.
