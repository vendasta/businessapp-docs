---
title: Visibility settings for recorded meetings
...
**Private**  
Only meeting invitees to the Calendar event in your account can view the Meeting Recording or Meeting Summary Page.

**All**  
Anyone in your account can view the Meeting Recording or Meeting Summary Page. A CRM activity is logged.

**Anyone with the link**  
Anyone in your account with access to the Meeting Summary Page link can view it. The meeting will not appear in the CRM.
...
This is a user-level setting and does not affect others in your account.
...
>
  ...
  >
    <iframe
      src="https://fast.wistia.net/embed/iframe/blsu4i17jst9y7p?web_component=true&seo=true"
      title="Visibility Settings Demo"
...
>
  ...
  >
    <iframe
      src="https://fast.wistia.net/embed/iframe/dv7nw4olyoccmkl?web_component=true&seo=true"
      title="Visibility Settings After the Meeting Demo"
      allow="autoplay; fullscreen"
      allowTransparency
      frameBorder="0"
      scrolling="no"
...
:::note
For meetings created by someone outside your account, you must manually add the Notetaker. Use **Record a live meeting** and paste the meeting link. Zoom and Microsoft Teams links are supported. If your Zoom account isn't connected, you're prompted to connect it before the Notetaker can join.
:::
...
<details>
  ...
  Only invitees within your account, if any.
</details>
...
<details>
  ...
  Yes, but only visible to the meeting participants or invitees in your account.
</details>
