...
Select if you'd like that Team Meeting Type to have [Round Robin](how-do-i-use-round-robin-in.mdx)
...
- The location field will be blank unless the Team Member using it has set up the [Zoom integration](how-to-use-zoom-details-in-meeting.mdx), in which case, their Zoom link will be generated upon booking
