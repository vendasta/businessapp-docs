...
You also have the option to choose "Select Custom Availability." This lets you create a scheduling link for the specific recipient you are currently emailing (meaning anyone in the "To" or "CC" fields) and choose specific times you want to offer that recipient for that specific meeting. [Click here](how-do-i-suggest-specific-times-for.mdx) to learn more about offering custom availability.  
### Use in a Template
