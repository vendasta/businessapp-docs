---
title: Templates
description: Create, use, and share email templates in Yesware to send consistent, personalized messages faster.
sidebar_position: 0
...
<details>
<summary>Can I add a video to a template?</summary>

Not directly. Take a screenshot of the video, insert it as an image in the template, then hyperlink the image to the video URL. This gives recipients a clickable thumbnail.
...
<details>
<summary>Can I export my templates?</summary>

No. Template export is not available. The best alternative is to copy and paste the template content manually from the Yesware template library.
