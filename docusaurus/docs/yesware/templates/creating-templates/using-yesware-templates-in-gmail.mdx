...
description: Efficiency tips and steps for using and inserting Yesware templates in your Gmail messages.
tags: [yesware, templates]
keywords: [using Yesware templates, insert Gmail templates, fill-in templates, template merge fields, Yesware usage guide]
sidebar_position: 209
---

# Using Yesware Templates in Gmail
...
### Creating and Editing Templates
Templates can be created in four places - from the Templates library at the top of Gmail, directly from the Gmail compose window, from an email thread, and from the Templates editor in the [Yesware App](https://app.yesware.com/template_library/manage).
...
You can access Template reporting by clicking on the [Reports](https://app.yesware.com/reports/templates/#/templates/by_user) section of Yesware. Here, we provide a quick overview of the usage and performance of personal and Team templates.
