...
- Click "Save &amp; Reload"
From now on, whenever you send an email, that message and all of its associated replies, message opens, link clicks, and attachment views will be stored to Salesforce as Activities on an existing Contact or Lead. The email will sync as an Activity to the [first single Contact or Lead](../../salesforce-integration/salesforce-sync-enterprise-plan/what-happens-if-i-have-duplicate-records.mdx) and optionally the first single Account or Opportunity associated with the email address.