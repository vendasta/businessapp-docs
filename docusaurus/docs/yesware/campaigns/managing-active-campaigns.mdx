...
- Integrate with your CRM for reliable tracking
...
Before managing your campaigns, it's helpful to understand how email delivery works:

**Yesware queues and hands off emails:** When you add recipients to a campaign, Yesware doesn't send the emails directly. Instead, it queues them and hands them off to your email provider (Gmail or Outlook) for delivery during the scheduled time window.

**Delivery timing may vary:** Because your email provider handles the actual sending, delivery times can be affected by:
- Email server availability and processing load
- Campaign size (larger campaigns take longer to fully process)
- Your email provider's sending limits and rate throttling

**Plan for time windows:** When scheduling campaigns, expect emails to be delivered within a time window rather than at an exact moment. This helps ensure better deliverability and prevents spam flags.
...
:::info
These are monthly recipient limits. Your account may also enforce a **daily recipient cap** that limits how many new recipients you can add within a rolling 24-hour window, separate from the monthly limits above. See [Daily Recipient Cap](../settings/daily-recipient-cap/index.mdx) for details.
:::
...
While direct downloads from the Campaigns section are not available, you can access detailed performance insights through the Reports section. By selecting Campaigns by Campaigns, you'll access a detailed report to evaluate and optimize your campaign strategy.

#### Key features of the campaigns by campaigns report

**Sorting:** Sort data across engagement metrics to identify which strategies perform best.

**Recipient tracking:** Track recipient engagement and progression across multiple campaigns to refine your audience targeting.

**Meeting booking analysis:** See which campaigns drive the most booked meetings.

**Customizable date range:** Adjust the date range to focus your analysis on specific time periods.

To access your campaign insights, go to the Reports section and select Campaigns by Campaigns.
...
2. For any recipient that had a send time window that was scheduled in the past (meaning the time window for which the original send was scheduled has come and gone since you paused the Campaign), you will be able to reschedule, or you can accept the default to send it immediately
...
Pausing a campaign will prevent follow-up touches from going out. If you have emails already queued for delivery, hitting the Pause button may not stop them since they have already been handed off to your email provider for processing.
:::
...
**Important:** Remember that Yesware hands off emails to your email provider for delivery during scheduled time windows. Larger campaigns may experience longer processing times as your email provider works through the queue.

**Workaround:** To manage the number of emails being sent and avoid delays, you can:
- Adjust the timing of adding recipients to campaigns, sending smaller batches at different time windows
- Break large lists into multiple smaller campaigns
- Modify the frequency of touchpoints within campaigns to control the flow of emails

This approach helps manage both your expectations and your email provider's ability to process sends efficiently.
