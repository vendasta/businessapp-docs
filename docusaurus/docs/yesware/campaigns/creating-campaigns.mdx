...
- Automatically enroll recipients in a follow-up campaign after this one completes

## Understanding email delivery

When you schedule automated emails in a campaign, it's important to understand how the delivery process works:

**Yesware queues emails for your email provider:** Yesware doesn't send emails directly. Instead, it hands off your campaign emails to your email provider (Gmail or Outlook) for delivery during the scheduled time window.

**Delivery may be delayed:** The actual send time can vary depending on several factors:
- Email server load and availability
- Campaign size (larger campaigns may take longer to process)
- Your email provider's sending limits and throttling

**Time windows, not exact times:** Rather than expecting emails to send at a precise moment, think of scheduled sends as time windows during which your email provider will process and deliver the messages.

This approach helps ensure deliverability and prevents your emails from being flagged as spam by spreading sends over a reasonable timeframe.
...
- **After completion:** Optionally choose a follow-up campaign to automatically enroll recipients in once they complete this campaign without responding
...
#### Automatically enroll recipients in a follow-up campaign after completion

The **After completion** section lets you automatically move recipients into a different campaign once they finish this one without responding.

To set this up:

1. In the **After completion** section of your campaign settings, choose a follow-up campaign from the list of campaigns you have access to.
2. Enter the number of days to wait after this campaign completes before the follow-up campaign starts.
...
If your campaign's **Remove recipients after connection** setting is enabled, recipients who reply, connect by phone, or book a meeting are removed from this campaign before it completes, so they are not moved into the follow-up campaign. If that setting is disabled, connected recipients remain in this campaign and are still enrolled in the follow-up campaign once it completes.

:::info
Recipients who previously opted out of your emails, or whose email address has bounced, are not enrolled in the follow-up campaign, even if they otherwise meet the completion criteria.
:::

Keep in mind:

- You can't set a campaign to chain into itself, or create a loop where campaigns eventually chain back to an earlier campaign in the sequence.
- If the follow-up campaign is paused or deleted before the delay ends, the recipient is not enrolled.
- Cloning a campaign does not carry over its **After completion** setting—you'll need to set this up again on the new campaign.
- A recipient can be chained into the follow-up campaign again if they complete this campaign more than once, even if they've already been through the follow-up campaign before.
...
- **Automated Email:** Queued for delivery during the scheduled time window
...
**Automated emails** are queued for delivery during the scheduled time window without any human intervention. Use automated emails for:
...
<details>
<summary>Can I add a GIF to my campaign?</summary>
...
<details>
<summary>Is there a maximum number of touches I can have in a campaign?</summary>
...
<details>
<summary>How do I access my to-do list for manual campaign tasks in Gmail?</summary>
...
<details>
<summary>How do I send a manual email via campaigns from Gmail?</summary>
...
<details>
<summary>Can I automatically move recipients into another campaign once they finish this one?</summary>

Yes. Use the **After completion** setting in your campaign settings to choose a follow-up campaign and a delay (in days). Recipients who complete every touch in the campaign without replying, connecting by phone, or booking a meeting are automatically enrolled in the follow-up campaign after that delay. Recipients who reply, connect, or book a meeting before the campaign completes are not moved into the follow-up campaign.
