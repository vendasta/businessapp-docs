...
This page explains Yesware's approach at a high level. For security documentation, privacy policies, and reporting, contact [support@yesware.com](mailto:support@yesware.com).
...
For anything not covered here, contact [support@yesware.com](mailto:support@yesware.com).

## Privacy and data protection

Yesware's privacy practices govern how data is collected, processed, and protected across the platform. The following are available by contacting [support@yesware.com](mailto:support@yesware.com):
...
- **[Salesforce](../salesforce/index.mdx)** – Manage how email activity and data sync with your CRM
- **[BCC to CRM](../bcc-to-crm/index.mdx)** – Control how copies of your outgoing email are routed to your CRM
