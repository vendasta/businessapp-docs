---
title: "Salesforce"
description: "Guide to integrating Yesware with Salesforce for CRM syncing"
---

Yesware's Enterprise plan includes Salesforce integration capabilities that help you keep your CRM up-to-date with all your email activities, calls, and meetings. This guide covers how to use and manage your Salesforce integration.
...
- Step 3: Select fields to display. Click the Settings gear button and `Select fields to display`. From there, move the fields to the visible fields section. This will add the fields that will show in your list view in Campaigns. Click Save
...
If you use Outlook Web Access, or you're a PC user on Outlook Version 2008 (Build 13127.21064) or above, you can use the regular Outlook Send button to send a tracked and synced email, instead of the Send with Yesware button.
