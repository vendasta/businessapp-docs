...
- Use Outlook Web Access or reach out to support@yesware.com and ask for Direct Install.
...
Campaigns allows you to create personalized emails that can be sent to up to 900 recipients at a time.
