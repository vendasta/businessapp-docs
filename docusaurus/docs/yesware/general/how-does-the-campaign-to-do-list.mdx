...
The [Campaigns to-do list](/docs/campaigns/creating-campaigns#access-your-to-do-list) is designed to help you stay on task by creating to-do cards for each manual touch type that's currently due. Future activity is hidden from view. To-dos can be [manual emails](/docs/campaigns/creating-campaigns#send-a-manual-email), [phone calls](/docs/general/how-do-i-take-an-action-on), or [custom tasks](/docs/general/how-do-i-take-action-on-a).
