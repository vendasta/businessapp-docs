...
To take action on a Phone Call task, you must go to the [Campaigns tab of the Yesware sidebar](/docs/campaigns/creating-campaigns#access-your-to-do-list).  If you've just added Manual tasks, don't forget to refresh the sidebar.  From there, select the to-do card for your Phone Call and click on the word "Call."
