---
title: "How Do I Create a Custom Meeting Type in Meeting Scheduler in Outlook?"
description: "How Do I Create a Custom Meeting Type in Meeting Scheduler in Outlook?"
sidebar_position: 161
slug: /yesware/general/how-do-i-create-a-custom-meeting-outlook
---

# How Do I Create a Custom Meeting Type in Meeting Scheduler in Outlook?

To create a Custom Meeting Type in Meeting Scheduler, navigate to your [Meeting Scheduler settings](https://app.yesware.com/account/meeting_scheduler). If you're in a compose window, click "Insert Meeting Link" in your Sidebar and then select the gear icon in the Meeting Scheduler Menu.
To get started, click "Create Meeting Type" about halfway down the Meeting Scheduler Settings page.
Fill out the below Meeting Details:
...
If you are a Team Leader and want to create a Meeting Type for your Team, please [click here](https://support.yesware.com/hc/en-us/articles/15420539892887) to learn how.