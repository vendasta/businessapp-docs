...
All you need to do is drop your CRM's unique address in Yesware's preferences. You can read the full instructions [here](how-do-i-enable-bcc-to-crm.mdx).
...
[Salesforce:](../../salesforce-integration/salesforce-sync-enterprise-plan/yesware-s-salesforce-integration-for-gmail.mdx)
