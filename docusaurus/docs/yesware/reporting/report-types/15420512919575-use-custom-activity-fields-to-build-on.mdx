...
# Use custom Activity Fields to build on your existing SFDC reports

Your reps are using Yesware to automatically sync activity to Salesforce on our Enterprise plan. Now what?
