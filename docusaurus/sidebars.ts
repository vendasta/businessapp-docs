    ...
    },
    {
      ...
      items: [
        ...
        // Subcategories (autogenerated within each folder)
        {
          type: 'category',
          label: 'App Settings',
          link: { type: 'doc', id: 'administration/app-settings/app_settings' },
          items: [{ type: 'autogenerated', dirName: 'administration/app-settings' }],
        },
        {
          type: 'category',
          label: 'Connections',
          link: { type: 'doc', id: 'administration/connections/app_settings_connections' },
